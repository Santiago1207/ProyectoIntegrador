...
// ------------------- Configuración (Hace parte de etapa 3) -------------------
constexpr uint8_t N_SAMPLES = 12;
constexpr uint8_t TRIM = 2; // recorta 2 máx + 2 mín
